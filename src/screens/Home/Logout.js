  ...
  class Logout extends React.Component {
    ...
    _sendLogout = async () => {
        ...
        try{
            ...
            await Axios.get('http://192.168.1.20:5000/myhire/logout')
    ...
    render(){
      return(
        <Container style={{marginTop : 100}}>
          <Text style={{fontSize : 24,textAlign : 'center'}}>Want to Logout?</Text>
          <Text style={{fontSize : 24,textAlign : 'center'}}>You'll Redirect to Login Page</Text>
           <Button 
                onPress={() => {this._sendLogout()}}
                style={{margin: 15, borderRadius: 10 , width : 100, justifyContent : 'center', alignItems : 'center', left : 120}} 
